...
MAJOR_ARCANA = [
    {"id": 0, "name": "The Fool", "name_kr": "바보", "name_zh": "愚者", "name_ja": "愚者",
    ...
    {"id": 1, "name": "The Magician", "name_kr": "마법사", "name_zh": "魔术师", "name_ja": "魔術師",
    ...
    {"id": 2, "name": "The High Priestess", "name_kr": "여사제", "name_zh": "女祭司", "name_ja": "女教皇",
    ...
    {"id": 3, "name": "The Empress", "name_kr": "여황제", "name_zh": "女皇", "name_ja": "女帝",
    ...
    {"id": 4, "name": "The Emperor", "name_kr": "황제", "name_zh": "皇帝", "name_ja": "皇帝",
    ...
    {"id": 5, "name": "The Hierophant", "name_kr": "교황", "name_zh": "教皇", "name_ja": "教皇",
    ...
    {"id": 6, "name": "The Lovers", "name_kr": "연인", "name_zh": "恋人", "name_ja": "恋人",
    ...
    {"id": 7, "name": "The Chariot", "name_kr": "전차", "name_zh": "战车", "name_ja": "戦車",
    ...
    {"id": 8, "name": "Strength", "name_kr": "힘", "name_zh": "力量", "name_ja": "力",
    ...
    {"id": 9, "name": "The Hermit", "name_kr": "은둔자", "name_zh": "隐士", "name_ja": "隠者",
    ...
    {"id": 10, "name": "Wheel of Fortune", "name_kr": "운명의 수레바퀴", "name_zh": "命运之轮", "name_ja": "運命の輪",
    ...
    {"id": 11, "name": "Justice", "name_kr": "정의", "name_zh": "正义", "name_ja": "正義",
    ...
    {"id": 12, "name": "The Hanged Man", "name_kr": "매달린 남자", "name_zh": "倒吊人", "name_ja": "吊るされた男",
    ...
    {"id": 13, "name": "Death", "name_kr": "죽음", "name_zh": "死神", "name_ja": "死神",
    ...
    {"id": 14, "name": "Temperance", "name_kr": "절제", "name_zh": "节制", "name_ja": "節制",
    ...
    {"id": 15, "name": "The Devil", "name_kr": "악마", "name_zh": "恶魔", "name_ja": "悪魔",
    ...
    {"id": 16, "name": "The Tower", "name_kr": "타워", "name_zh": "高塔", "name_ja": "塔",
    ...
    {"id": 17, "name": "The Star", "name_kr": "별", "name_zh": "星星", "name_ja": "星",
    ...
    {"id": 18, "name": "The Moon", "name_kr": "달", "name_zh": "月亮", "name_ja": "月",
    ...
    {"id": 19, "name": "The Sun", "name_kr": "태양", "name_zh": "太阳", "name_ja": "太陽",
    ...
    {"id": 20, "name": "Judgement", "name_kr": "심판", "name_zh": "审判", "name_ja": "審判",
    ...
    {"id": 21, "name": "The World", "name_kr": "세계", "name_zh": "世界", "name_ja": "世界",
...
# 마이너 아르카나 설정
SUIT_CONFIG = {
    "Wands": {"kr": "완드", "zh": "权杖", "ja": "ワンド", "folder": "iloveimg-compressed-2", "prefix": "완드"},
    "Cups": {"kr": "컵", "zh": "圣杯", "ja": "カップ", "folder": "iloveimg-compressed-3", "prefix": "컵"},
    "Swords": {"kr": "소드", "zh": "宝剑", "ja": "ソード", "folder": "iloveimg-compressed-4", "prefix": "소드"},
    "Pentacles": {"kr": "펜타클", "zh": "星币", "ja": "ペンタクル", "folder": "iloveimg-compressed", "prefix": "펜타클"}
}

COURT_NAMES = ["에이스", "2", "3", "4", "5", "6", "7", "8", "9", "10", "페이지", "나이트", "퀸", "킹"]
COURT_ENGLISH = ["Ace", "2", "3", "4", "5", "6", "7", "8", "9", "10", "Page", "Knight", "Queen", "King"]
COURT_CHINESE = ["首牌", "二", "三", "四", "五", "六", "七", "八", "九", "十", "侍从", "骑士", "王后", "国王"]
COURT_JAPANESE = ["エース", "2", "3", "4", "5", "6", "7", "8", "9", "10", "ペイジ", "ナイト", "クイーン", "キング"]
...
for suit, config in SUIT_CONFIG.items():
    ...
    for i, court_name in enumerate(COURT_NAMES):
        ...
        card_name_zh = f"{config['zh']}{COURT_CHINESE[i]}"
        card_name_ja = f"{config['ja']}の{COURT_JAPANESE[i]}"
        
        MINOR_ARCANA.append({
            "id": card_id,
            "name": card_name,
            "name_kr": card_name_kr,
            "name_zh": card_name_zh,
            "name_ja": card_name_ja,
            "suit": suit,
